// pra n ter perigo troquei todos os nomes...
 ...
 */
int insert_l(struct list *desc, int pos, elem item);
 ...
 * @return 1 se OK, 0 se erro
 */
int removel_l(struct list *desc, int pos);
 ...
 * @return elemento
 */
elem get_l(struct list *desc, int pos);
 ...
 * @return 1 se OK, 0 se erro
 */
int set_l(struct list *desc, int pos, elem item);
